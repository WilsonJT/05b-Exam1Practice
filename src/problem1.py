...
def run_test_problem1a():
    ...
    # Test 3
    expected = 0.536  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([0, 6], expected, test_results,
                                  format_string)
    actual = problem1a(0, 6)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    # Test 4
    expected = 0.508  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([9, 121], expected, test_results,
                                  format_string)
    actual = problem1a(9, 121)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
